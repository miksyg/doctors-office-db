...
BEGIN
      select a.appointmentdate as 'DATE', a.appointmenttime as 'TIME',  concat(r.roomcode,', ', r.roomdescription) AS 'ROOM', concat(p.firstname,' ', p.lastname) as 'PATIENT' from appointment a inner join doctor d on a.doctorid = d.doctorid
...
-- Dump completed on 2022-07-04 20:13:41
